...
public class ShipController : MonoBehaviour
{
    ...
    IEnumerator StartPlayer()
    {
        ...
        while (t < duration)
        {
            // En cada instante, calculamos una nueva posición que estará entre la inicial y la final
            t += Time.deltaTime;
    ...
    void DestroyShip()
    {
        ...
        // Reducir una vida en el GameManager
        ...
        if (gm != null)
        {
            ...
            if (gm.IsGameOver())
            {
                // Destruir la nave sin reiniciarla
        ...
        // Reiniciar la nave solo si no es Game Over
        StartCoroutine("StartPlayer");
    }
